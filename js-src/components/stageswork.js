...
// const componentsInfoSlider = document?.querySelectorAll(".block-stages__slider");

if (document.querySelector("[data-tabs='tabs-stageswork']")) {
  const sliderTabs = new GraphTabs("tabs-stageswork", {
    isChanged: (tabs) => {
